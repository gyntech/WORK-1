...
public class FellowController {
	...
	@RequestMapping(value = {"/fellow/dashboard2"}, method = RequestMethod.GET)
    public String fellow2Home(){
        return "fellow/dashboard2";
    }
	
	
	
	@RequestMapping(value = {"/fphys1"}, method = RequestMethod.GET)
    public String step1(){
        return "fellow/phys1";
    }
	...
	@RequestMapping(value = {"/fphys2"}, method = RequestMethod.GET)
    public String step2(){
        return "fellow/phys2";
    }
	...
	@RequestMapping(value = {"/fphys3"}, method = RequestMethod.GET)
    public String step3(){
        return "fellow/phys3";
    }
	...
	@RequestMapping(value = {"/fphys4"}, method = RequestMethod.GET)
    public String step4(){
        return "fellow/phys4";
    }
...
MathsService mathsService;
	...
	public FellowController(StaffService staffService, MathsService mathsService,EvangelismService evangelismService, EvangelismtService evangelismtService, EvangelismpService evangelismpService,
			EvangelismsService evangelismsService) {
    ...
    @RequestMapping(value = {"/haycod101"}, method = RequestMethod.GET)
    public String cod101(){
        return "fellow/cod101";
    }
    
    
    @RequestMapping(value = {"/hayfed101"}, method = RequestMethod.GET)
    public String fed101(){
        return "fellow/fed101";
    }
    
    
    @RequestMapping(value = {"/haybed101"}, method = RequestMethod.GET)
    public String bed101(){
        return "fellow/bed101";
    }
    
	
    
    
    @RequestMapping(value = {"/approvelook"}, method = RequestMethod.GET)
    public String applook(){
        return "fellow/approvalook";
    }
	 ...
	 @RequestMapping(value = {"/fdashboard"}, method = RequestMethod.GET)
	 ...
	 @RequestMapping(value = {"/fstucandsuc"}, method = RequestMethod.GET)
	 public String suEvangelisms(Model model, 
	   		 @Param("keyword") String keyword) {
	    ...
	    @RequestMapping(value = {"/fstucands"}, method = RequestMethod.GET)
	    ...
	    @RequestMapping(value = {"/fusprofcands"}, method = RequestMethod.GET)
		 ...
		 @RequestMapping(value = {"/fstucands/new"}, method = RequestMethod.GET)
		 public String createEvangelismForm(Model model) {
		 	...
		 	return "fellow/create_candidate";
		 }

		 @RequestMapping(value = {"/fstucandsuc"}, method = RequestMethod.POST)
		 public String saveEvangelism(@ModelAttribute("question") Evangelism evangelism) {
			 evangelismService.saveEvangelism(evangelism);
		 return "redirect:/fstucandsuc";
		 }

		 @RequestMapping(value = {"/fstucands/edit/{id}"}, method = RequestMethod.GET)
		 ...
		 return "fellow/edit_candidate";
		 }
		 
		 

		 @RequestMapping(value = {"/fstucands2/edit/{id}"}, method = RequestMethod.GET)
		 public String editEvangelismForm2(@PathVariable Long id, Model model) {
		 model.addAttribute("evangelism", evangelismService.getEvangelismById(id));
		 return "fellow/edit_candidate2";
		 }
		 
		 

		 @RequestMapping(value = {"/fstucands3/edit/{id}"}, method = RequestMethod.GET)
		 public String editEvangelismForm3(@PathVariable Long id, Model model) {
		 model.addAttribute("evangelism", evangelismService.getEvangelismById(id));
		 return "fellow/edit_candidate3";
		 }
		 
		 

		 @RequestMapping(value = {"/fstucands4/edit/{id}"}, method = RequestMethod.GET)
		 public String editEvangelismForm4(@PathVariable Long id, Model model) {
		 model.addAttribute("evangelism", evangelismService.getEvangelismById(id));
		 return "fellow/edit_candidate4";
		 }
		 
		 
		 @RequestMapping(value = {"/fstucands/{id}"}, method = RequestMethod.POST)
		 ...
		 return "redirect:/stucands";
		 }

		 //handler method to handle delete maths request

		 @RequestMapping(value = {"/fstucands/{id}"}, method = RequestMethod.GET)
		 ...
		 return "redirect:/stucands";
		    ...
		    @RequestMapping(value = {"/perlook"}, method = RequestMethod.GET)
		    public String perlook(){
		        return "fellow/perlook";
		    }
		    ...
		    @RequestMapping(value = {"/fstutaskssuc"}, method = RequestMethod.GET)
		   	public String suctasks(Model model, 
		   	   		 @Param("keyword") String keyword) {
		         	...
		         	return "fellow/tasksuc";
		       }
		    
		    
		    
		    @RequestMapping(value = {"/fstutasks"}, method = RequestMethod.GET)
		       ...
		       @RequestMapping(value = {"/fstutasks/new"}, method = RequestMethod.GET)
		       public String createtaskForm(Model model) {
		   		 Evangelismt evangelismt = new Evangelismt();
		   	 	model.addAttribute("evangelismt",evangelismt);
		   	 	return "fellow/create_task";
		       }

		       @RequestMapping(value = {"/fstutaskssuc"}, method = RequestMethod.POST)
		       public String savetask(@ModelAttribute("question") Evangelismt evangelismt){
		    	evangelismtService.saveEvangelismt(evangelismt);
		   	 return "redirect:/fstutaskssuc";
		   	 }
		       

		       @RequestMapping(value = {"/fstutasks/edit/{id}"}, method = RequestMethod.GET)
		       public String edittaskForm(@PathVariable Long id, Model model) {
		   		 model.addAttribute("evangelismt", evangelismtService.getEvangelismtById(id));
		   		 return "fellow/edit_task";
		   		 }


		       @RequestMapping(value = {"/fstutasks/{id}"}, method = RequestMethod.POST)
		    ...
		    evangelismtService.updateEvangelismt(existingEvangelismt);
		       return "redirect:/fstutasks";
		       }

		       //handler method to handle delete maths request

		       @RequestMapping(value = {"/fstutasks/{id}"}, method = RequestMethod.GET)
		       public String task(@PathVariable Long id) {
			    ...
			    @RequestMapping(value = {"/giftlook"}, method = RequestMethod.GET)
			    public String giftlook(){
			        return "fellow/giftlook";
			    }
			    
		       

			       @RequestMapping(value = {"/fusposressuc"}, method = RequestMethod.GET)
			     	public String suctposrestasks(Model model, 
			     	   		 @Param("keyword") String keyword) {
			     	   	 List<Evangelisms> listEvangelismss = evangelismsService.getAllEvangelismss(keyword);
			     	   	 model.addAttribute("listEvangelismss", listEvangelismss);
			     	   	 model.addAttribute("keyword", keyword);
			     	   	model.addAttribute("evangelismss",evangelismsService.getAll());
			           	return "fellow/posresuc";
			         }
		       ...
		       @RequestMapping(value = {"/fstpos"}, method = RequestMethod.GET)
		       ...
		       @RequestMapping(value = {"/fusposres"}, method = RequestMethod.GET)
		     	public String stposrestasks(Model model, 
		          ...
		          @RequestMapping(value = {"/fstpos/new"}, method = RequestMethod.GET)
		          public String poscreatetaskForm(Model model) {
		      	 	...
		      	 	return "fellow/create_pos";
		          }

		          @RequestMapping(value = {"/fusposressuc"}, method = RequestMethod.POST)
		          public String possavetask(@ModelAttribute("questiont") Evangelisms evangelisms) {
		      		 evangelismsService.saveEvangelisms(evangelisms);
		      	 return "redirect:/fusposressuc";
		      	 }
		          

		          @RequestMapping(value = {"/fusposres/edit/{id}"}, method = RequestMethod.GET)
		          public String posedittaskForm(@PathVariable Long id, Model model) {
		      		 ...
		      		 return "fellow/edit_pos";
		      		 }


		          @RequestMapping(value = {"/fusposres/{id}"}, method = RequestMethod.POST)
		       ...
		       evangelismsService.updateEvangelisms(existingEvangelisms);
		          return "redirect:/fusposres";
		          }

		          //handler method to handle delete maths request

		          @RequestMapping(value = {"/fusposres/{id}"}, method = RequestMethod.GET)
		          public String postask(@PathVariable Long id) {
		      	 ...
		      	 return "redirect:/fusposres";
				    ...
				    @RequestMapping(value = {"/tracklook"}, method = RequestMethod.GET)
				    public String tracklook(){
				        return "fellow/tracklook";
				    }
		          ...
		          @RequestMapping(value = {"/fphysuc"}, method = RequestMethod.GET)
					 public String suappEvangelismp(Model model, 
					   		 @Param("keyword") String keyword) {
				    ...
				    @RequestMapping(value = {"/fphys"}, method = RequestMethod.GET)
					 public String fappEvangelismp(Model model, 
					   		 @Param("keyword") String keyword) {
					   	 List<Evangelismp> listEvangelismps = evangelismpService.getAllEvangelismps(keyword);
					   	 model.addAttribute("listEvangelismps", listEvangelismps);
					   	 model.addAttribute("keyword", keyword);
					 ...
					 @RequestMapping(value = {"/fphys/new"}, method = RequestMethod.GET)
					 public String fcreateEvangelismpForm(Model model) {
						 Evangelismp evangelismp = new Evangelismp();
					 	model.addAttribute("evangelismp",evangelismp);
					 	return "fellow/create_week";
					 }
					 
					 
					 

					 @RequestMapping(value = {"/fphys2/new"}, method = RequestMethod.GET)
					 public String fcreateEvangelismpForm2(Model model) {
						 Evangelismp evangelismp = new Evangelismp();
					 	model.addAttribute("evangelismp",evangelismp);
					 	return "fellow/create_week2";
					 }
					 
					 
					 

					 @RequestMapping(value = {"/fphysuc"}, method = RequestMethod.POST)
					 public String fsaveEvangelismp(@ModelAttribute("question") Evangelismp evangelismp) {
						 evangelismpService.saveEvangelismp(evangelismp);
					 return "redirect:/fphysuc";
					 }

					 @RequestMapping(value = {"/fphys/edit/{id}"}, method = RequestMethod.GET)
					 public String feditEvangelismpForm(@PathVariable Long id, Model model) {
					 model.addAttribute("evangelismp", evangelismpService.getEvangelismpById(id));
					 return "fellow/edit_week";
					 }
					 
					 
					 
					 @RequestMapping(value = {"/fphys2/edit/{id}"}, method = RequestMethod.GET)
					 public String feditEvangelismpForm2(@PathVariable Long id, Model model) {
					 model.addAttribute("evangelismp", evangelismpService.getEvangelismpById(id));
					 return "fellow/edit_week2";
					 }
					 
					 
					 
					 
					 @RequestMapping(value = {"/fphys3/edit/{id}"}, method = RequestMethod.GET)
					 public String feditEvangelismpForm3(@PathVariable Long id, Model model) {
					 model.addAttribute("evangelismp", evangelismpService.getEvangelismpById(id));
					 return "fellow/edit_week3";
					 }
					 ...
					 @RequestMapping(value = {"/fphys/{id}"}, method = RequestMethod.POST)
					 public String fupdateEvangelismp(@PathVariable Long id, 
					 ...
					 return "redirect:/fphys";
					 }

					 //handler method to handle delete maths request

					 @RequestMapping(value = {"/fphys/{id}"}, method = RequestMethod.GET)
					 public String fEvangelismp(@PathVariable Long id) {
					 ...
					 return "redirect:/fphys";
						...
						@RequestMapping(value = {"/fetramat"}, method = RequestMethod.GET)
				...
				@RequestMapping(value = {"/femaths"}, method = RequestMethod.GET)
				public String listMathsfe(Model model,
						 @Param("keyword") String keyword) {
					 List<Maths> listMathss = mathsService.getAllMathss(keyword);
					 model.addAttribute("listMathss", listMathss);
					 model.addAttribute("keyword", keyword);
					 model.addAttribute("mathss", mathsService.getAll());
					return "fellow/staffmat";
				}
				
				

				@RequestMapping(value = {"/femaths/new"}, method = RequestMethod.GET)
				public String createmathsFormfe(Model model) {
					Maths maths = new Maths();
					model.addAttribute("maths", maths);
					return "fellow/create_maths";
				}
				
				

				 
				 @RequestMapping(value = {"/femaths"}, method = RequestMethod.POST)
					public String saveMathsfe(@ModelAttribute("maths") Maths maths) {
					 mathsService.saveMaths(maths);
						return "redirect:/femaths?keyword=Type in the Requisition ID";
					}
					 
				
				

				 @RequestMapping(value = {"/femaths/edit/{id}"}, method = RequestMethod.GET)
				public String editMathsFormfe(@PathVariable Long id, Model model) {
					model.addAttribute("maths", mathsService.getMathsById(id));
					return "fellow/edit_maths";
				}
				 
				 
					
				 @RequestMapping(value = {"/femaths/{id}"}, method = RequestMethod.POST)
				public String updateMathsfe(@PathVariable Long id, 
					...
					// handler method to handle delete member request
					 ...
					 @RequestMapping(value = {"/femaths/{id}"}, method = RequestMethod.GET)
						public String deleteMathsfe(@PathVariable Long id) {
						...
						@RequestMapping(value = {"/festaffs"}, method = RequestMethod.GET)
						public String felistStaffs(Model model, 
						   		 @Param("keyword") String keyword) {
						...
						@RequestMapping(value = {"/ferece"}, method = RequestMethod.GET)
						public String ferecelisttrack(Model model, 
						   		 @Param("keyword") String keyword) {
							 List<Staff> listStaffs = staffService.getAllStaffs(keyword);
							 model.addAttribute("listStaffs", listStaffs);
							 model.addAttribute("keyword", keyword);
						...
						@RequestMapping(value = {"/fetrack"}, method = RequestMethod.GET)
						public String listtrackfe(Model model, 
						   		 @Param("keyword") String keyword) {
							 List<Staff> listStaffs = staffService.getAllStaffs(keyword);
							 model.addAttribute("listStaffs", listStaffs);
							 model.addAttribute("keyword", keyword);
						...
						@RequestMapping(value = {"/festaffs/new"}, method = RequestMethod.GET)
						public String createStaffFormfe(Model model) {
							Staff staff = new Staff();
							model.addAttribute("staff", staff);
							return "fellow/create_staff";
						}
						
						
						

						@RequestMapping(value = {"/felocstaffs/new"}, method = RequestMethod.GET)
						public String createlocStaffFormfe(Model model) {
							Staff staff = new Staff();
							model.addAttribute("staff", staff);
					 ...
					 @RequestMapping(value = {"/festaffs"}, method = RequestMethod.POST)
					public String fesaveStaff(@ModelAttribute("staff") Staff staff) {
						 staffService.saveStaff(staff);
						return "redirect:/festaffs?keyword=Type in the Requisition ID";
					}

					 @RequestMapping(value = {"/fetrack/edit/{id}"}, method = RequestMethod.GET)
					public String editStaffFormfe(@PathVariable Long id, Model model) {
						model.addAttribute("staff", staffService.getStaffById(id));
						return "fellow/edit_staff";
					}
					 
					 
					 

					 @RequestMapping(value = {"/fetrack/{id}"}, method = RequestMethod.POST)
					public String feupdateStaff(@PathVariable Long id, 
					...
					// handler method to handle delete staff request
					 ...
					 @RequestMapping(value = {"/festaffs/{id}"}, method = RequestMethod.GET)
