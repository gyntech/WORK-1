...
MathsService mathsService;
	...
	public PmController(StaffService staffService, MathsService mathsService,EvangelismService evangelismService, EvangelismtService evangelismtService, EvangelismpService evangelismpService,
			EvangelismsService evangelismsService) {
    ...
    public String fellowHomepm(){
        return "pm/dashboard";
						...
						@RequestMapping(value = {"/ptramat"}, method = RequestMethod.GET)
						public String listtrmatp(Model model, 
				...
				@RequestMapping(value = {"/pmaths"}, method = RequestMethod.GET)
				public String listMathsp(Model model,
						 @Param("keyword") String keyword) {
					 List<Maths> listMathss = mathsService.getAllMathss(keyword);
					 model.addAttribute("listMathss", listMathss);
					 model.addAttribute("keyword", keyword);
				...
				@RequestMapping(value = {"/pmaths/new"}, method = RequestMethod.GET)
				public String createmathsFormp(Model model) {
					Maths maths = new Maths();
					model.addAttribute("maths", maths);
					return "pm/create_maths";
				}
				
				

				 
				 @RequestMapping(value = {"/pmaths"}, method = RequestMethod.POST)
					public String saveMathsp(@ModelAttribute("maths") Maths maths) {
					 mathsService.saveMaths(maths);
						return "redirect:/pmaths?keyword=Type in the Requisition ID";
					}
					 
				
				

				 @RequestMapping(value = {"/pmaths/edit/{id}"}, method = RequestMethod.GET)
				public String editMathsForp(@PathVariable Long id, Model model) {
					model.addAttribute("maths", mathsService.getMathsById(id));
					return "pm/edit_maths";
				}
				 
				 
					
				 @RequestMapping(value = {"/pmaths/{id}"}, method = RequestMethod.POST)
				public String updateMathsp(@PathVariable Long id, 
					...
					// handler method to handle delete member request
					 ...
					 @RequestMapping(value = {"/pmaths/{id}"}, method = RequestMethod.GET)
						public String deleteMathsp(@PathVariable Long id) {
						...
						@RequestMapping(value = {"/pstaffs"}, method = RequestMethod.GET)
						public String plistStaffs(Model model, 
						   		 @Param("keyword") String keyword) {
						...
						@RequestMapping(value = {"/prece"}, method = RequestMethod.GET)
						public String precelisttrack(Model model, 
						   		 @Param("keyword") String keyword) {
							 List<Staff> listStaffs = staffService.getAllStaffs(keyword);
							 model.addAttribute("listStaffs", listStaffs);
							 model.addAttribute("keyword", keyword);
						...
						@RequestMapping(value = {"/ptrack"}, method = RequestMethod.GET)
						public String listtrackp(Model model, 
						   		 @Param("keyword") String keyword) {
							 List<Staff> listStaffs = staffService.getAllStaffs(keyword);
							 model.addAttribute("listStaffs", listStaffs);
							 model.addAttribute("keyword", keyword);
						...
						@RequestMapping(value = {"/pstaffs/new"}, method = RequestMethod.GET)
						public String createStaffFormp(Model model) {
						...
						@RequestMapping(value = {"/plocstaffs/new"}, method = RequestMethod.GET)
						public String createlocStaffFormp(Model model) {
							Staff staff = new Staff();
							model.addAttribute("staff", staff);
					 ...
					 @RequestMapping(value = {"/pstaffs"}, method = RequestMethod.POST)
					public String psaveStaff(@ModelAttribute("staff") Staff staff) {
						 staffService.saveStaff(staff);
						return "redirect:/festaffs?keyword=Type in the Requisition ID";
					}

					 @RequestMapping(value = {"/ptrack/edit/{id}"}, method = RequestMethod.GET)
					public String editStaffFormp(@PathVariable Long id, Model model) {
					 ...
					 @RequestMapping(value = {"/ptrack/{id}"}, method = RequestMethod.POST)
					public String pupdateStaff(@PathVariable Long id, 
						...
						return "redirect:/pstaffs?keyword=Type in the Requisition ID";
					}

					// handler method to handle delete staff request

					 @RequestMapping(value = {"/pstaffs/{id}"}, method = RequestMethod.GET)
						public String pStaff(@PathVariable Long id) {
